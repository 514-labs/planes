...
export const aircraftStatsModel = defineQueryModel({
  ...
  description:
    "Speed and altitude statistics by aircraft category",
  table: T,
  ...
  metrics: {
    ...
    uniqueAircraftCount: {
      agg: countDistinct(T.columns.hex),
      as: "unique_aircraft_count",
    },
    avgBarometricAltitude: {
      agg: avg(T.columns.alt_baro),
      as: "avg_barometric_altitude",
    },
    minBarometricAltitude: {
      agg: min(T.columns.alt_baro),
      as: "min_barometric_altitude",
    },
    maxBarometricAltitude: {
      agg: max(T.columns.alt_baro),
      as: "max_barometric_altitude",
    },
    altitudeStddev: {
      agg: sql`STDDEV_POP(${T.columns.alt_baro})`,
      as: "altitude_stddev",
    },
    ...
    speedStddev: {
      agg: sql`STDDEV_POP(${T.columns.gs})`,
      as: "speed_stddev",
    },
  },
  ...
  filters: {
    category: {
      column: "category",
      operators: ["eq", "ne"] as const,
    },
    altitude: {
      column: "alt_baro",
      operators: ["gt", "gte", "lte"] as const,
    },
    speed: {
      column: "gs",
      operators: ["gt", "gte", "lte"] as const,
